// lib/features/operator/algeria_takaful/dashboard/widgets/at_application_card.dart
...
class AtApplicationCard extends StatelessWidget {
  final PolicyModel policy;
  final VoidCallback onTap;

  const AtApplicationCard({
    super.key,
