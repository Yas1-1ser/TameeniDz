...
class AtNotificationsScreen extends ConsumerWidget {
  const AtNotificationsScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    const scaffoldBg = AppColors.bgPage;
    const textDark = AppColors.darkBrown;
    const textMuted = AppColors.midBrown;
    const accentColor = AppColors.beigeGold;
    const cardBg = Colors.white;
    const borderCol = AppColors.borderLight;
                  ...
                  return GestureDetector(
                    onTap: () async {
                      ...
                      if (referenceId != null && referenceId.isNotEmpty) {
                        context.push('/at/application/$referenceId');
                      }
                    },
                    child: Container(
