...
// ── Al-Ittihad accent colour ──────────────────────────────────────────────
const Color _kAiBlue = Color(0xFF1B4F72);
const Color _kAiBlueFaint = Color(0xFFEBF5FB);
...
class _AiApplicationDetailScreenState extends ConsumerState<AiApplicationDetailScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(AppLocalizations.of(context)!.errorGeneric(e.toString()), style: GoogleFonts.ibmPlexSansArabic()),
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Column(
            children: [
              Text(
                l10n.requestDetails,
                style: GoogleFonts.amiri(color: _kAiBlue, fontWeight: FontWeight.bold, fontSize: 18),
              ),
              Text(
                l10n.ittihadPortal,
        ...
        body: PageEntryAnimation(
          child: policyAsync.when(
            ...
            loading: () => Center(
              child: CircularProgressIndicator(color: _kAiBlue)
        ...
        children: [
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _kAiBlue.withValues(alpha: 0.08),
                ...
                Container(
                  ...
                  height: 3,
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(colors: [_kAiBlue, Color(0xFF2980B9)]),
          ...
          _buildInfoCard(
            ...
            details: [
              ...
              (l10n.submissionDateColon, DateFormat('yyyy/MM/dd').format(policy.submittedAt)),
            ],
          )
              .animate()
              .fadeIn(duration: 500.ms, delay: stagger * i++, curve: Curves.easeOut)
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          color: picked ? _kAiBlueFaint : null,
          borderRadius: BorderRadius.circular(kRadiusMd),
          border: Border.all(
            color: picked ? _kAiBlue : kDivider,
            width: picked ? 2 : 1,
          ),
          boxShadow: [kCardShadow],
        ),
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: picked ? _kAiBlue.withValues(alpha: 0.15) : kParchment,
                borderRadius: BorderRadius.circular(kRadiusSm),
              ),
              child: Icon(
                picked ? Icons.check_circle_rounded : Icons.upload_file_rounded,
                color: picked ? _kAiBlue : kInkMuted,
                size: 24,
              ),
            ),
            ...
            Expanded(
              child: Text(
                ...
                style: GoogleFonts.ibmPlexSansArabic(
                  fontSize: 13,
                  fontWeight: FontWeight.bold,
                  color: picked ? _kAiBlue : kInk,
                ),
              ),
            ),
            if (!picked) const Icon(Icons.arrow_upward_rounded, color: _kAiBlue),
          ],
        ),
      ),
    )
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.amiri(fontSize: 15, fontWeight: FontWeight.bold, color: _kAiBlue),
          ),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              filled: true,
              fillColor: kIvory,
              prefixIcon: const Icon(Icons.monetization_on_rounded, color: _kAiBlue),
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSm), borderSide: const BorderSide(color: kParchment)),
              enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSm), borderSide: const BorderSide(color: kParchment)),
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSm), borderSide: const BorderSide(color: _kAiBlue, width: 1.5)),
            ),
          ),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: const Padding(
                ...
                child: Icon(Icons.edit_note_rounded, color: _kAiBlue),
              ),
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSm), borderSide: const BorderSide(color: kParchment)),
              enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSm), borderSide: const BorderSide(color: kParchment)),
              focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(kRadiusSm), borderSide: const BorderSide(color: _kAiBlue, width: 1.5)),
  ...
  Widget _buildRequestTypeBadge(PolicyModel policy, AppLocalizations l10n) {
    ...
    final color = isQuote ? kGoldDeep : const Color(0xFF00695C);
  ...
  Widget _buildSectionTitle(String title) {
    return Row(
      children: [
        ...
        Text(
          title,
          style: GoogleFonts.amiri(fontSize: 17, fontWeight: FontWeight.bold, color: _kAiBlue),
        ),
      ],
    );
  }
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(title, style: GoogleFonts.ibmPlexSansArabic(fontWeight: FontWeight.bold, fontSize: 15, color: kInk)),
            ...
            (d) => Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(d.$2, style: GoogleFonts.ibmPlexSansArabic(fontSize: 13, fontWeight: FontWeight.bold, color: kInk)),
                ],
              ),
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: const Icon(Icons.file_copy_rounded, color: _kAiBlue, size: 22),
                ),
                const SizedBox(height: 10),
                Padding(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.ibmPlexSansArabic(fontSize: 11, fontWeight: FontWeight.bold, color: kInk),
                ...
                Text(l10n.previewFile, style: GoogleFonts.ibmPlexSansArabic(fontSize: 9, color: _kAiBlue, fontWeight: FontWeight.bold)),
              ],
            ),
          ),
        )
  ...
  Widget _actionBtn(String label, Color color, VoidCallback onTap, {bool isPrimary = false}) {
    return ElevatedButton(
      ...
      child: Text(
        label,
        style: GoogleFonts.ibmPlexSansArabic(fontWeight: FontWeight.bold, fontSize: 11),
      ),
    );
  }
  ...
  Future<void> _decide(PolicyModel policy, PolicyStatus newStatus) async {
    ...
    if (newStatus != PolicyStatus.accepted && _reasonCtrl.text.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(l10n.pleaseWriteNotesFirst)));
      return;
    }
