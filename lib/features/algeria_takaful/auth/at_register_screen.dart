...
class AtRegisterScreen extends StatefulWidget {
  const AtRegisterScreen({super.key});

  @override
  State<AtRegisterScreen> createState() => _AtRegisterScreenState();
}

class _AtRegisterScreenState extends State<AtRegisterScreen> {
        ...
        child: Stack(
            children: [
              ...
              SafeArea(
                child: _success
                    ? SuccessView(
                        company: operatorCompanies.firstWhere((c) => c.id == 'algeria_takaful'),
                        isAr: isAr)
                    : Column(
                        children: [
    ...
    return Container(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            const SectionLabel(
                label: 'إنشاء حساب جديد - جزائر تكافل',
